...
public class MainMiddleCourse extends RecyclerView.Adapter<MainMiddleCourse.ViewHolder> {
    ...
    public MainMiddleCourse(ArrayList<RecyclerViewItem> mList) {
        this.mList = mList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MainMiddleCourse.ViewHolder vh = new MainMiddleCourse.ViewHolder(view);
        return vh;
    }

    // position에 해당하는 데이터를 뷰홀더의 아이템뷰에 표시
    @Override
    public void onBindViewHolder(@NonNull MainMiddleCourse.ViewHolder holder, int position) {
