...
public class MainTopCourseAdapter extends RecyclerView.Adapter<MainTopCourseAdapter.CourseViewHolder> {

    private final List<CourseModel> courses;

    public MainTopCourseAdapter(List<CourseModel> courses) {
    ...
    @NonNull
    @Override
    public MainTopCourseAdapter.CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_coruse, parent, false);
        return new MainTopCourseAdapter.CourseViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MainTopCourseAdapter.CourseViewHolder holder, int position) {
