...
public class MainBottomCourse extends RecyclerView.Adapter<MainBottomCourse.ViewHolder> {
    ...
    public MainBottomCourse(ArrayList<RecyclerViewItem> mList) {
        this.mList = mList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MainBottomCourse.ViewHolder vh = new MainBottomCourse.ViewHolder(view);
        return vh;
    }

    // position에 해당하는 데이터를 뷰홀더의 아이템뷰에 표시
    @Override
    public void onBindViewHolder(@NonNull MainBottomCourse.ViewHolder holder, int position) {
